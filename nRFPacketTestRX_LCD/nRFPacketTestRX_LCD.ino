...
{  
  ...
  lcd.setCursor(1,0);
  lcd.print("Packets: ");
  lcd.print(packetsRead);
  lcd.setCursor(2,1);
  lcd.print("Sample: ");
  lcd.print((packetsRead - lastPacketCount));
  lcd.setCursor(5,2);
  lcd.print("PPS: ");
  lcd.print((packetsRead - lastPacketCount)* 1000 / (now - lastScreenUpdate));
  lcd.setCursor(2,3);
  lcd.print("Time ");
  lcd.print(data.hours);
  lcd.print("h ");
  lcd.print(data.minutes);
  lcd.print("m ");
  lcd.print(data.seconds);
  lcd.print("s ");
